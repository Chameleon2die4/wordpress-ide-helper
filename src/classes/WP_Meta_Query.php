...
class WP_Meta_Query {
     ...
     *         @type string          $type_key    MySQL's data type that the meta_key column will be CAST to for
     ...
     *         @type string          $type        MySQL's data type that the meta_value column will be CAST to for
     *                                            comparisons. Accepts:
     *                                            - 'NUMERIC'
     *                                            - 'BINARY'
     *                                            - 'CHAR'
     ...
     *
     *     @type string $join  SQL fragments to append to the main JOIN clause.
     *     @type string $where SQL fragments to append to the main WHERE clause.
     * }
     */
