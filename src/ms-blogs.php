 ...
 * @noinspection SqlNoDataSourceInspection*@global wpdb $wpdb WordPress database abstraction object.
 *
 * @since MU (3.0.0)
 *
 */
 ...
 * @noinspection PhpUnusedParameterInspection*@see restore_current_blog()
 * @since MU (3.0.0)
 *
 * @global wpdb            $wpdb               WordPress database abstraction object.
 * @global int             $blog_id
